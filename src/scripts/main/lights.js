...
// // Point
// gui.add(spotLight.position, 'x', -5, 5, 0.01, ).name('PointLight X')
// gui.add(spotLight.position, 'y', -5, 5, 0.01, ).name('PointLight Y')
// gui.add(spotLight.position, 'z', -5, 5, 0.01, ).name('PointLight Z')